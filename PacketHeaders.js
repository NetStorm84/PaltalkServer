...
const PACKET_TYPES = {
    ...
    IM_IN: 0x0014,
    ROOM_JOIN: -310,
    ROOM_JOIN_REQUEST: -311,
    ROOM_JOIN_AS_ADMIN: -316,
    ROOM_LEAVE: -320,
    ROOM_USER_LEFT: 0x0140,
    ROOM_CREATE: -300,
    ROOM_BOUNCE: -380,
    ROOM_BOUNCE_USER: -380,  // Same as ROOM_BOUNCE
    ROOM_BOUNCE_REASON: -381,  // Admin sends bounce with reason
    ROOM_CLOSE: -940,
    ROOM_CLOSED: 0x017C,
    ROOM_START_PUBLISH_VIDEO: -6010,
    ROOM_STOP_PUBLISH_VIDEO: -6012,
    ROOM_TRANSMITTING_VIDEO: 0x0138,
    ...
    PACKET_ROOM_GET_ADMIN_INFO: -900,
    ...
    PACKET_ROOM_RED_DOT_USER: -381,
    PACKET_ROOM_UNRED_DOT_USER: -397,
    PACKET_ROOM_RED_DOT_VIDEO: -931,
    PACKET_ROOM_RED_DOT_TEXT: -930,
